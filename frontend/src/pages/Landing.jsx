    ...
    <div className="min-h-screen bg-background dark:bg-dark-bg">
          ...
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <div className="bg-secondary/20 p-4 rounded-full">
                <Leaf className="h-16 w-16 text-secondary" />
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/login"
                className="px-8 py-4 bg-accent text-primary-dark rounded-lg hover:bg-amber-600 transition-colors font-bold text-lg flex items-center justify-center"
              >
                Login / Sign Up
              ...
              <button
                ...
                className="px-8 py-4 bg-secondary text-primary-dark rounded-lg hover:bg-secondary-light transition-colors font-bold text-lg"
              >
      ...
      <div className="bg-primary-dark text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/login"
            className="px-8 py-4 bg-accent text-primary-dark rounded-lg hover:bg-amber-600 transition-colors font-bold text-lg inline-flex items-center"
          >
            Get Started Now
            <ArrowRight className="ml-2 h-5 w-5" />
          </Link>
      ...
      {/* Footer */}
      <footer className="bg-background py-8 border-t border-gray-200">
