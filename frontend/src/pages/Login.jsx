      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link to="/" className="flex items-center justify-center space-x-2 mb-6">
            ...
            <span className="text-2xl font-bold text-primary-dark">NutriWasteAI</span>
          </Link>
        ...
        <div className="bg-white dark:bg-dark-card rounded-xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent dark:bg-dark-card dark:text-dark-text"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-white py-3 rounded-lg hover:bg-primary-dark transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
